...
class LoginPageLocators():
	...
	PASSWORD_LINK = (By.CSS_SELECTOR, "[name='registration-password1']")
	PASSWORD_CONF_LINK = (By.CSS_SELECTOR, "[name='registration-password2']")
	SEND_BTN = (By.CSS_SELECTOR, "[name='registration_submit']")
